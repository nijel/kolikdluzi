...
DATABASES = {
    'default': {
        ...
        'NAME': 'dluhy.db',                      # Or path to database file if using sqlite3.
        'USER': 'dluhy',                      # Not used with sqlite3.
        'PASSWORD': 'dluhy',                  # Not used with sqlite3.
...
SERVER_EMAIL = 'django@kolikdluzi.cz'
